...
def main():
    ...
    parser.add_argument(
        "--data-path", type=str, help="Path to dataset directory (required for real data)"
    )
    parser.add_argument(
        "--epochs",
        type=int,
    ...
    if not args.data_path and args.dataset not in ["both", "all"]:
        ...
        if args.dataset == "annomi":
            print(
                "1. Download: https://www.kaggle.com/datasets/rahulmenon1758/annomi-motivational-interviewing"
            )
            ...
            print(
                "3. Download: https://www.kaggle.com/datasets/kushparmar02/social-media-sentiments-analysis-dataset"
            )
        elif args.dataset == "vr_driving":
            print(
                "4. Download: https://www.kaggle.com/datasets/sasanj/virtual-reality-driving-simulator-dataset"
            )
        elif args.dataset == "autvi":
            print("5. Download: https://www.kaggle.com/datasets/hassanmojab/autvi")
        elif args.dataset == "digakust":
            print(
                "6. Download: https://www.kaggle.com/datasets/resc28/digakust-dataset-mensa-saarland-university"
            )
        print(
            f"7. Run: python train_kaggle_datasets.py --dataset {args.dataset} --data-path /path/to/dataset"
        )
        print()
    ...
    print(
        f"Training configuration: {args.epochs} epochs, {args.batch_size} batch size, {args.learning_rate} learning rate"
    )
