...
from core.time_manager import TimeConfig, TimeManager, set_time_manager
...
def demonstrate_problem_and_solution():
    ...
    print("After advancing 100 simulation steps:")
    ...
    print("  - Simulation completed instantly while tracking real performance!")
    ...
    time_scenarios = [(6, "Dawn"), (12, "Noon"), (18, "Evening"), (22, "Night"), (2, "Late Night")]
    ...
    for sim_time, description in time_scenarios:
        ...
        print(
            f"{description:12} (hour {sim_time:2d}): phase={node.phase:12} circadian={node.circadian_cycle}"
        )
