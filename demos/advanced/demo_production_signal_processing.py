...
def demo_production_features():
    ...
    print(f"✓ Poison message detected and moved to DLQ")
    ...
    print(f"✓ Invalid schema version rejected")
    ...
    print(f"✓ Backpressure handled gracefully\n")
