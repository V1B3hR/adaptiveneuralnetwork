...
class TestFullSystemIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.capacitor1 = CapacitorInSpace(
            position=(10, 10), 
            capacity=30, 
            initial_energy=20
        )
        self.capacitor2 = CapacitorInSpace(
            position=(-10, -10), 
            capacity=25, 
            initial_energy=15
        )
    ...
    def test_energy_conservation(self):
        ...
        self.assertLess(energy_difference, initial_total * 0.2)  # Allow 20% variance for movement costs
