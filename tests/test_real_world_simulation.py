...
from core.real_world_adapter import (
    RealWorldSimulator, SimulatedSensor, TransferLearningValidator,
    SensorType, SensorReading, EnvironmentScenario
)
...
class TestTransferLearningValidator(unittest.TestCase):
    ...
    def test_transfer_report_generation(self):
        ...
        self.validator.evaluate_transfer(
            self.mock_model, "urban_environment", "industrial_environment", 
            self.mock_test_data
        )
    ...
    def test_integration_scenario(self):
        ...
        transfer_results = self.validator.evaluate_transfer(
            self.mock_model, "urban_environment", "natural_environment",
            self.mock_test_data, adaptation_steps=10
        )
