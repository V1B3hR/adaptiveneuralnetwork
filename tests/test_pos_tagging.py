...
from adaptiveneuralnetwork.data.kaggle_datasets import (
    load_pos_tagging_dataset, POSDataset, get_pos_dataset_statistics,
    _load_pos_data, _compute_pos_statistics, _build_pos_vocabularies
)
from adaptiveneuralnetwork.models.pos_tagger import (
    POSTagger, POSTaggerConfig, compute_token_accuracy, 
    masked_cross_entropy_loss, compute_sequence_lengths
)
...
class TestPOSUtilities(unittest.TestCase):
    ...
    def test_compute_sequence_lengths(self):
        ...
        from adaptiveneuralnetwork.models.pos_tagger import compute_sequence_lengths
