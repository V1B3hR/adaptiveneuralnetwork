...
class TestTrustNetwork(unittest.TestCase):
    ...
    def test_trust_volatility_limits(self):
        ...
        for _ in range(10):
            ...
            self.assertLessEqual(
                change, self.trust_net.TRUST_VOLATILITY_LIMIT + 0.001
            )  # Small tolerance
    ...
    def test_suspicion_threshold(self):
        ...
        self.assertEqual(
            self.trust_net.suspicion_alerts[self.target.node_id]["status"], "pending_verification"
        )
    ...
    def test_community_feedback_processing(self):
        ...
        feedback = [{"trust_level": 0.1}, {"trust_level": 0.2}, {"trust_level": 0.15}]
