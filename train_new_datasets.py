...
def simulate_training(dataset_type: str, dataset, epochs: int) -> Dict[str, Any]:
    ...
    for epoch in range(epochs):
        ...
        train_history.append({"epoch": epoch + 1, "accuracy": accuracy, "loss": loss})
...
def main():
    ...
    if not args.data_path:
        ...
        if args.dataset == "vr_driving":
            print(
                "   https://www.kaggle.com/datasets/sasanj/virtual-reality-driving-simulator-dataset"
            )
        elif args.dataset == "autvi":
            print("   https://www.kaggle.com/datasets/hassanmojab/autvi")
        elif args.dataset == "digakust":
            print(
                "   https://www.kaggle.com/datasets/resc28/digakust-dataset-mensa-saarland-university"
            )
        print(
            f"2. Run: python train_new_datasets.py --dataset {args.dataset} --data-path /path/to/dataset"
        )
        print()
