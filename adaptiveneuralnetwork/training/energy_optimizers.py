...
class EnergyAwareOptimizer(Optimizer):
    ...
    def __init__(
        ...
        **kwargs
        ...
        defaults = dict(lr=lr, energy_scaling=energy_scaling, energy_threshold=energy_threshold, **kwargs)
...
class EnergyAwareAdam(EnergyAwareOptimizer):
    ...
    def __init__(
        ...
        super().__init__(
            params, node_state, phase_scheduler, lr=lr,
            energy_scaling=energy_scaling, energy_threshold=energy_threshold,
...
class MetaAdaptiveOptimizer(EnergyAwareOptimizer):
    ...
    def __init__(
        ...
        super().__init__(
            params, node_state, phase_scheduler, lr=lr,
            energy_scaling=energy_scaling, energy_threshold=energy_threshold,
            meta_lr=meta_lr, adaptation_window=adaptation_window
        )
    ...
    def step(self, closure=None, current_performance: float | None = None):
