...
class TextClassificationBaseline:
    ...
    def _check_dependencies(self):
        ...
        try:
            ...
            warnings.warn(
                "scikit-learn not available. Install with: pip install 'adaptiveneuralnetwork[nlp]'"
            )
    ...
    def _create_classifier(self):
        ...
        return LogisticRegression(
            C=self.C, random_state=self.random_state, max_iter=1000, solver="lbfgs"
        )
    ...
    def evaluate(self, texts: List[str], labels: List[Union[str, int]]) -> Dict[str, Any]:
        """
    ...
    def get_feature_importance(self, top_k: int = 20) -> Dict[str, List[Tuple[str, float]]]:
        ...
        for i, class_name in enumerate(self.label_encoder.classes_):
            ...
            top_features = [(feature_names[idx], float(coef[idx])) for idx in top_indices]
...
def create_demo_baseline(
    num_samples: int = 1000, num_classes: int = 3, random_state: int = 42
    ...
    try:
        ...
        train_df, val_df = create_synthetic_bitext_data(
            num_samples=num_samples, num_classes=num_classes, random_seed=random_state
        )
...
if __name__ == "__main__":
    ...
    if baseline is not None:
        ...
        # Demo prediction
        print("\n3. Demo prediction:")
        test_texts = ["hello world artificial intelligence", "quick brown fox jumps over lazy dog"]
