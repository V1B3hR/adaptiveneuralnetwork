...
from ..production.messaging import HybridMessageQueue, MessagingConfig
...
class SDKConfig:
    ...
    # Messaging settings
    messaging_config: MessagingConfig | None = None
...
class SDKClient:
    ...
    async def load_local_model(self, model_path: str | None = None) -> bool:
...
class AdaptiveNeuralNetworkSDK:
    ...
    def create_simple(cls, server_url: str = "http://localhost:8000",
                     api_key: str | None = None) -> 'AdaptiveNeuralNetworkSDK':
