...
class PluginRegistry:
    ...
    def get_plugin_class(self, plugin_name: str) -> type[PluginBase] | None:
...
class PluginManager:
    ...
    def __init__(self, config: AdaptiveConfig, registry: PluginRegistry | None = None):
        self.config = config
    ...
    def load_plugin(self, plugin_name: str, plugin_config: dict[str, Any] | None = None) -> bool:
