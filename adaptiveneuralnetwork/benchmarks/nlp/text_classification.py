...
class TextClassificationBenchmark:
    ...
    def __init__(self, config: AdaptiveConfig, device: torch.device | None = None):
        """
    ...
    def run_essay_classification_benchmark(
        self,
        dataset: EssayDataset | None = None,
        epochs: int = 50,
        batch_size: int = 32,
        ...
        logger.info(f"Essay classification benchmark completed. "
