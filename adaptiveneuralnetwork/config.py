...
class AdaptiveNeuralNetworkConfig:
    ...
    @classmethod
    def from_yaml(cls, yaml_path: str | Path) -> "AdaptiveNeuralNetworkConfig":
    ...
    @classmethod
    def from_json(cls, json_path: str | Path) -> "AdaptiveNeuralNetworkConfig":
        ...
        try:
            ...
            raise ValueError(f"Error parsing JSON file {json_path}: {e}") from e
...
_global_config: AdaptiveNeuralNetworkConfig | None = None
