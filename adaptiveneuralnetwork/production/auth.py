...
class AuthConfig:
    ...
    oauth2_server_url: Optional[str] = None
...
class AuthManager:
    ...
    def create_user(self, username: str, email: str, password: str, 
                   is_admin: bool = False, scopes: Optional[List[str]] = None) -> User:
        """Create a new user."""
...
class OAuth2Auth(AuthManager):
    ...
    async def exchange_code_for_token(self, code: str, state: Optional[str] = None) -> Optional[OAuth2Token]:
    ...
    async def authenticate_oauth2(self, code: str) -> Optional[User]:
...
class MultiAuthManager:
    ...
    def authenticate(self, auth_type: str, **kwargs) -> Optional[User]:
