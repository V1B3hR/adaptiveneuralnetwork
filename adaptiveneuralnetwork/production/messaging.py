...
class MessagingConfig:
    ...
    # RabbitMQ config
    rabbitmq_url: str | None = None  # e.g., "amqp://user:pass@localhost/"
...
class MessageQueue:
    ...
    async def send_message(self, topic: str, message: dict[str, Any], key: str | None = None) -> None:
...
class HybridMessageQueue:
    ...
    async def send_message(self, topic: str, message: dict[str, Any], key: str | None = None,
