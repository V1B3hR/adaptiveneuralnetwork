...
class ContextualEmbedding(nn.Module):
    ...
    def forward(self, input_ids: torch.Tensor, char_ids: Optional[torch.Tensor] = None) -> torch.Tensor:
        """
...
class SemanticRoleLabeler(nn.Module):
    ...
    def forward(self, input_ids: torch.Tensor, predicate_masks: Optional[torch.Tensor] = None) -> Dict[str, torch.Tensor]:
        """
