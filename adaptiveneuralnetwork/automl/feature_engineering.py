...
class PhaseBasedFeatureGenerator:
    ...
    def fit(self, X: pd.DataFrame, y: pd.Series | None = None) -> 'PhaseBasedFeatureGenerator':
...
class EnergyDrivenInteractionTerms:
    ...
    def fit(self, X: pd.DataFrame, y: pd.Series | None = None) -> 'EnergyDrivenInteractionTerms':
...
class StatisticalTransformationEngine:
    ...
    def fit(self, X: pd.DataFrame, y: pd.Series | None = None) -> 'StatisticalTransformationEngine':
    ...
    def _select_transformation(self, series: pd.Series, skewness: float, kurtosis: float) -> str | None:
...
class NeuromorphicFeatureEngineer:
    ...
    def fit(self, X: pd.DataFrame, y: pd.Series | None = None) -> 'NeuromorphicFeatureEngineer':
