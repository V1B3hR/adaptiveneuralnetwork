...
class EnergyGuidedFeatureImportance:
    ...
    def fit(self, X: pd.DataFrame, y: Optional[pd.Series] = None) -> 'EnergyGuidedFeatureImportance':
    ...
    def fit_transform(self, X: pd.DataFrame, y: Optional[pd.Series] = None) -> Dict[str, float]:
