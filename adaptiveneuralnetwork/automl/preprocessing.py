...
class EnergyAwareMissingValueImputer:
    ...
    def fit(self, X: pd.DataFrame, y: pd.Series | None = None) -> 'EnergyAwareMissingValueImputer':
...
class SpikeBasedOutlierDetector:
    ...
    def fit(self, X: pd.DataFrame, y: pd.Series | None = None) -> 'SpikeBasedOutlierDetector':
...
class AdaptiveFeatureScaler:
    ...
    def fit(self, X: pd.DataFrame, y: pd.Series | None = None) -> 'AdaptiveFeatureScaler':
...
class NeuromorphicPreprocessor:
    ...
    def fit(self, X: pd.DataFrame, y: pd.Series | None = None) -> 'NeuromorphicPreprocessor':
