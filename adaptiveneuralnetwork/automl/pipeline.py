...
class NeuromorphicPipeline:
    ...
    def fit(self, X: pd.DataFrame, y: Optional[pd.Series] = None) -> 'NeuromorphicPipeline':
    ...
    @classmethod
    def load_pipeline(cls, file_path: Union[str, Path]) -> 'NeuromorphicPipeline':
...
class AutoMLWorkflow:
    ...
    def __init__(
        self,
        pipeline: Optional[NeuromorphicPipeline] = None,
        config: Optional[PipelineConfig] = None,
        neuromorphic_enabled: bool = True,
        random_state: int = 42
    ):
    ...
    def save_workflow(self, file_path: Union[str, Path]):
    ...
    @classmethod
    def load_workflow(cls, file_path: Union[str, Path]) -> 'AutoMLWorkflow':
