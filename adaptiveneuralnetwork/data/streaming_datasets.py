...
class WebDatasetWrapper(UnifiedDatasetInterface):
    ...
    def __init__(
        ...
        try:
            ...
            raise ImportError("WebDataset not installed. Install with: pip install webdataset") from e
    ...
    def __init__(
        ...
        **dataset_kwargs
        ...
        try:
            ...
            raise ImportError("HuggingFace Datasets not installed. Install with: pip install datasets") from e
