...
class SpiNNaker2Backend(BaseHardwareBackend):
    ...
    def _compile_population(self, layer: nn.Module, layer_name: str, population_id: int) -> Optional[Dict[str, Any]]:
    ...
    def _find_source_population(self, module: nn.Module, pop_by_layer: Dict[str, Dict]) -> Optional[Dict[str, Any]]:
    ...
    def _find_target_population(self, module: nn.Module, pop_by_layer: Dict[str, Dict]) -> Optional[Dict[str, Any]]:
