...
from ..core import NodeState, PhaseScheduler, AdaptiveDynamics
...
class AdaptiveModel(nn.Module):
    ...
    def load_state_dict_full(self, state_dict: Dict[str, Any]) -> None:
        ...
        regular_state = {k: v for k, v in state_dict.items() 
                        if k not in ['node_state', 'scheduler_state']}
