...
class TestPhaseScheduler:
    ...
    def test_custom_circadian_period(self):
        ...
        scheduler = PhaseScheduler(num_nodes=5, circadian_period=50)
    ...
    def test_custom_phase_weights(self):
        ...
        scheduler = PhaseScheduler(num_nodes=5, phase_weights=custom_weights)
    ...
    def test_step_basic(self):
        ...
        activity = torch.tensor(
            [[[0.3], [0.8], [0.2]]]
        )  # Shape: [batch=1, nodes=3, activity_dim=1]
    ...
    def test_get_phase_stats(self):
        ...
        phases = torch.tensor([[0, 1, 2, 3], [0, 0, 1, 2]])
    ...
    def test_batch_processing(self):
        ...
        batch_size = 2
        energy = torch.tensor(
            [[[5.0], [10.0], [1.0]], [[15.0], [0.5], [8.0]]]  # Batch 1  # Batch 2
        )
        activity = torch.tensor(
            [[[0.5], [0.8], [0.2]], [[0.6], [0.3], [0.7]]]  # Batch 1  # Batch 2
        )
