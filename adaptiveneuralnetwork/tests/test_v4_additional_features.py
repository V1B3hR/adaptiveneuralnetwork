...
from ..training.distributed import DistributedConfig, DistributedTrainer, create_pytorch_distributed_config
from ..data.streaming_datasets import (
    StreamingConfig, StreamingDatasetWrapper, UnifiedDatasetManager,
    MultiDatasetWrapper, quick_stream_dataset
)
...
class TestGraphSpatialIntegration:
    ...
    def test_graph_spatial_integration_creation(self):
        ...
        from ..models.graph_spatial import GraphSpatialIntegration, GraphConfig
    ...
    def test_integrated_forward_pass(self):
        ...
        from ..models.graph_spatial import create_graph_spatial_model, GraphConfig
