...
class TestAliveLoopNodeConfigIntegration:
    ...
    def test_node_uses_default_config_values(self):
        ...
        node = AliveLoopNode(
            position=[0.0, 0.0], velocity=[0.0, 0.0], initial_energy=10.0, node_id=1
        )
    ...
    def test_node_uses_provided_config_values(self):
        ...
        node = AliveLoopNode(
            position=[0.0, 0.0], velocity=[0.0, 0.0], initial_energy=10.0, node_id=1, config=config
        )
