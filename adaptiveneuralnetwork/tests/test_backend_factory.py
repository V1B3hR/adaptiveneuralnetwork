...
class TestBackendFactory:
    ...
    def test_jax_backend_creation_when_available(self, mock_jax_model, mock_jax_available):
        ...
        with patch(
            "adaptiveneuralnetwork.api.backend_factory.convert_pytorch_to_jax_config"
        ) as mock_convert:
    ...
    def test_neuromorphic_backend_creation(self):
        ...
        with patch(
            "adaptiveneuralnetwork.core.neuromorphic.NeuromorphicAdaptiveModel"
        ) as mock_neuro_model:
            mock_instance = MagicMock()
...
class TestBackendCompatibility:
    ...
    def test_backend_parameter_validation(self):
        ...
        config = AdaptiveConfig(backend="pytorch", device="cpu", dtype="float32")
