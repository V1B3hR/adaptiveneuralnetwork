...
class TestSelfSupervisedLearning:
    ...
    def test_signal_predictor_initialization(self):
        ...
        config = SelfSupervisedConfig(prediction_horizon=5, context_window=20, hidden_dim=32)
    ...
    def test_self_supervised_system(self):
        ...
        config = SelfSupervisedConfig(
            prediction_horizon=5, context_window=15, hidden_dim=32, embedding_dim=16
        )
...
class TestCurriculumLearning:
    ...
    def test_curriculum_system_creation(self):
        ...
        curriculum_system = create_curriculum_system(model, input_dim=128, output_dim=10)
...
class TestEnhancedMemorySystems:
    ...
    def test_dynamic_priority_buffer(self):
        ...
        # Test sampling
        sampled_features, sampled_labels, sampled_tasks, importance_weights, indices = (
            buffer.sample(5)
        )
...
class TestDynamicBenchmarking:
    ...
    def test_learning_curve_analyzer(self):
        ...
        config = DynamicBenchmarkConfig(
            plateau_threshold=0.02, plateau_patience=10, max_score_threshold=90.0
        )
...
class TestPhase1Integration:
    ...
    def test_continual_learning_with_enhanced_memory(self):
        ...
        from ..applications.continual_learning import (
...
def self_supervised_config():
    ...
    return SelfSupervisedConfig(
        prediction_horizon=5, context_window=20, hidden_dim=64, embedding_dim=32
    )
...
def curriculum_config():
    ...
    return CurriculumConfig(initial_difficulty=0.1, success_threshold=0.8, patience=10)


@pytest.fixture
def enhanced_memory_config():
    """Fixture for enhanced memory configuration."""
    return EnhancedMemoryConfig(memory_size=1000, importance_decay=0.99, priority_alpha=0.6)
...
def dynamic_benchmark_config():
    ...
    return DynamicBenchmarkConfig(
        plateau_threshold=0.02, max_score_threshold=90.0, difficulty_levels=[1.0, 1.5, 2.0, 2.5]
    )
