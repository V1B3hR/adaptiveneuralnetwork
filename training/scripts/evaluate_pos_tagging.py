...
from adaptiveneuralnetwork.data.kaggle_datasets import load_pos_tagging_dataset, POSDataset
from adaptiveneuralnetwork.models.pos_tagger import POSTagger

# Optional dependencies
try:
    from seqeval.metrics import classification_report, precision_recall_fscore_support, accuracy_score
    HAS_SEQEVAL = True
except ImportError:
    HAS_SEQEVAL = False
